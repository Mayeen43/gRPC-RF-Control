...
class RFSettingsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetRFSettings = channel.unary_unary(
                '/rfcontrol.RFSettingsService/SetRFSettings',
...
def add_RFSettingsServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'rfcontrol.RFSettingsService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('rfcontrol.RFSettingsService', rpc_method_handlers)
